          ...
          {filtered.map((item) => (
            ...
            >
              ...
              <div className="mt-2.5 pr-1">
                ...
                <p className="text-[11px] tracking-[0.06em] font-light text-accent-blue/70 group-hover:text-accent-blue transition-colors duration-300 mt-0.5 flex items-center gap-1.5">
                  <span>Link Here</span>
